...
int main() {
	...
	std::cout << "=================================\n";
	std::cout << "--- Определитель времени года ---\n";
	std::cout << "=================================\n\n";
	...
	// в функции ввода данных. Каждый case оформляю одной
	// строкой, т. к. в данном случае это более читаемо
	std::cout << "\n" << month << "-й месяц относится к ";

	switch (month) {
	case 12: case 1: case 2: // 1, 2, 12 месяцы - зима
		std::cout << "зиме"; break;
	case 3: case 4: case 5: // 3, 4, 5 месяцы - весна
		std::cout << "весне"; break;
	case 6: case 7: case 8: // 6, 7, 8 месяцы - лето
		std::cout << "лету"; break;
	case 9: case 10: case 11: // 9, 10, 11 месяцы - осень
		std::cout << "осени"; break;
	}
